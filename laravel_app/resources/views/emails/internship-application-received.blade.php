...
<head>
<meta charset="utf-8">
<title>Nueva postulación de practicante</title>
</head>
<body style="margin:0;padding:0;background:#F4F1EA;font-family:Arial,Helvetica,sans-serif;color:#0B1829;">
  <div style="max-width:560px;margin:0 auto;padding:28px 20px;">
    <div style="background:#0B1829;border-radius:10px 10px 0 0;padding:22px 26px;">
      ...
      <h1 style="font-size:19px;color:#fff;margin:0;font-weight:600;">Nueva postulación de practicante</h1>
    </div>
    <div style="background:#fff;border:1px solid #E7E1D3;border-top:none;border-radius:0 0 10px 10px;padding:26px;">
      <p style="font-size:14px;line-height:1.6;margin:0 0 18px;"><strong>{{ $application->full_name }}</strong> acaba de postular al programa de prácticas. Estos son los datos que envió:</p>
      ...
      <p style="font-size:12px;color:#9CA3AF;margin:22px 0 0;">Recibido el {{ $application->created_at->timezone('America/Lima')->format('d/m/Y H:i') }} · Ya está registrado en el panel admin, en Solicitudes de practicante.</p>
    </div>
  </div>
</body>
</html>
